...
--  LIMIT 100
 ...
 WITH ss AS (
    ...
    WHERE 
        ...
        AND DATE_TRUNC('day', CAST(d_date AS DATE)) BETWEEN CAST(DATE '1998-08-04' AS DATE) 
                                                        AND (CAST(DATE '1998-08-04' AS DATE) + INTERVAL '30' DAY)
        AND ss_store_sk = s_store_sk
    GROUP BY s_store_sk
),
sr AS (
